...
/// <summary>
/// Most losses where the player's team had a combined ELO at least an underdog gap higher than the opponents.
/// </summary>
public class ChokeArtistStat : StatBase
{
    public override StatKey Key => StatKey.ChokeArtist;
